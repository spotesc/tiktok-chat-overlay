...
const WebcastApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        fetchWebcastURL: async (client, roomId, uniqueId, cursor, sessionId, userAgent, preferredAgentIds, ttTargetIdc, clientEnter, options = {}) => {
...
const WebcastApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async fetchWebcastURL(client, roomId, uniqueId, cursor, sessionId, userAgent, preferredAgentIds, ttTargetIdc, clientEnter, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.fetchWebcastURL(client, roomId, uniqueId, cursor, sessionId, userAgent, preferredAgentIds, ttTargetIdc, clientEnter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
const WebcastApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        fetchWebcastURL(client, roomId, uniqueId, cursor, sessionId, userAgent, preferredAgentIds, ttTargetIdc, clientEnter, options) {
            return localVarFp.fetchWebcastURL(client, roomId, uniqueId, cursor, sessionId, userAgent, preferredAgentIds, ttTargetIdc, clientEnter, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve the currently connected WebSocket clients for your account. Only for paid plans.
         * @param {*} [options] Override http request option.
...
class WebcastApi extends base_1.BaseAPI {
     ...
     */
    fetchWebcastURL(client, roomId, uniqueId, cursor, sessionId, userAgent, preferredAgentIds, ttTargetIdc, clientEnter, options) {
        return (0, exports.WebcastApiFp)(this.configuration).fetchWebcastURL(client, roomId, uniqueId, cursor, sessionId, userAgent, preferredAgentIds, ttTargetIdc, clientEnter, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve the currently connected WebSocket clients for your account. Only for paid plans.
     * @param {*} [options] Override http request option.
